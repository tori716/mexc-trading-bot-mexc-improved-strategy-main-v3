...
def load_config():
    ...
    config = {
        ...
        "TIME_BASED_STOP_LOSS_MINUTES": int(os.getenv("TIME_BASED_STOP_LOSS_MINUTES", "45")),
        "TIME_BASED_STOP_LOSS_PROFIT_THRESHOLD": float(os.getenv("TIME_BASED_STOP_LOSS_PROFIT_THRESHOLD", "0.5")),
        
        # 改善された損切りパラメータ
        "BB_MID_BREAK_THRESHOLD_PERCENTAGE": float(os.getenv("BB_MID_BREAK_THRESHOLD_PERCENTAGE", "0.5")),
        "BB_MID_CONFIRMATION_CANDLES": int(os.getenv("BB_MID_CONFIRMATION_CANDLES", "2")),
        "PROGRESSIVE_STOP_LOSS_ENABLED": os.getenv("PROGRESSIVE_STOP_LOSS_ENABLED", "True").lower() == "true",
        "PROGRESSIVE_STOP_LOSS_STAGES": [
            {"time_minutes": 15, "loss_percentage": 0.8},
        ...
        "MAX_RECENT_LOSSES_PER_SYMBOL": int(os.getenv("MAX_RECENT_LOSSES_PER_SYMBOL", "2")),
        "REQUIRED_MARKET_CORRELATION": float(os.getenv("REQUIRED_MARKET_CORRELATION", "0.3")),
        "PRICE_STABILITY_FACTOR": float(os.getenv("PRICE_STABILITY_FACTOR", "1.5")),
        
        # 市場環境判定の改善設定
        "DYNAMIC_THRESHOLD_ENABLED": os.getenv("DYNAMIC_THRESHOLD_ENABLED", "True").lower() == "true",
        "MIN_MARKET_THRESHOLD": float(os.getenv("MIN_MARKET_THRESHOLD", "1.5")),
        "MAX_MARKET_THRESHOLD": float(os.getenv("MAX_MARKET_THRESHOLD", "3.0")),
        "VOLATILITY_MULTIPLIER": float(os.getenv("VOLATILITY_MULTIPLIER", "0.8")),
    ...
    numeric_vars = {
        ...
        "BB_MID_BREAK_THRESHOLD_PERCENTAGE": float,
        "BB_MID_CONFIRMATION_CANDLES": int,
        "MAX_RECENT_LOSSES_PER_SYMBOL": int,
        "REQUIRED_MARKET_CORRELATION": float,
